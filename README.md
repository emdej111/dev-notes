...
> Personal notes, cheat sheets and quick references — continuously updated while learning and building.
...
Notes following the [Claude Code in Action](https://anthropic.skilljar.com/claude-code-in-action/486929) course.
...
- **Verify and share**
  - [Trust It: Verifying Unsupervised Runs](Claude_Code_in_Action/04-verify-and-share/verifying-unsupervised.md)
  - [Plugins](Claude_Code_in_Action/04-verify-and-share/plugins.md)
